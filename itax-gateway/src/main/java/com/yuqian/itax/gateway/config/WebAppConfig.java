...
public class WebAppConfig implements WebMvcConfigurer {
	...
	public void addCorsMappings(CorsRegistry registry) {
		registry.addMapping("/**")
				...
				.allowedHeaders("Origin", "X-Requested-With", "Content-Type", "Accept", "X-AUTH-SESSION","Content-Security-Policy","X-Content-Type-Options","X-XSS-Protection","token","oemCode","accessPartyCode")
				.maxAge(3600);
