...
@Getter
@Setter
@Table(name="t_e_company_cancel_order_change_record")
public class CompanyCancelOrderChangeRecordEntity implements Serializable {
	...
	/**
	 * 订单状态 0-待付款,1-注销处理中,2-税务注销成功,3-已取消 4-税单待处理 5-工商注销成功
	 */
