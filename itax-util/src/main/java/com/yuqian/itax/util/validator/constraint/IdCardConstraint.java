...
public class IdCardConstraint implements ConstraintValidator<IdCard, String> {
	...
	public void initialize(IdCard constraintAnnotation) {
		log.info("IdCardConstraint initialize method invoke...");
	}

	@Override
	public boolean isValid(String value, ConstraintValidatorContext context) {
		return StringUtils.isBlank(value) || strongVerifyIdNumber(value);
	}
	...
	private static boolean checkIdNumberVerifyCode(String idNumber) {
		String validate=getVerifyCode(idNumber);
		if(StringUtils.isBlank(validate)){
			return false;
		}
		return validate.equalsIgnoreCase(idNumber.substring(17));
	}
	 ...
	 * @return
	 */
	public static String getChineseSex(String idNumber) {
		if (StringUtils.isBlank(idNumber)) {
			return null;
		}
		//15转18位
	...
	public static void main(String[] args) {
		System.out.println(strongVerifyIdNumber("430702199608264031"));
	}
