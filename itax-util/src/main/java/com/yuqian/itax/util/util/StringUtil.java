...
public class StringUtil {
	...
	/**
	 * 给指定字符串添加空格字符, 起始和结束位置可以为负，不会出现下标越界
	 * 
	 * @param msg, 示例：6092
	 * @return 示例返回：6 0 9 2
	 */
	public static String markSpace(String msg) {
		if (isEmpty(msg)) {
			return msg;
		}
		StringBuilder str = new StringBuilder("");
		for (int i = 0; i < msg.length(); i++) {
			str.append(msg.charAt(i)).append(SPACE_CHAR);
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(StringUtil.markSpace(StringUtil.subString("18075134720", -4, 0)));
		System.out.println(StringUtil.markSpace(StringUtil.subString("622588******6925", -4, 0)));
		System.out.println(StringUtil.markSpace("6092"));
		
		System.out.println(StringUtil.mark("6225882117901234", '*', 4, -4));
		System.out.println(StringUtil.mark("180751347205134720", '*', 4, -2));
		
		System.out.println(StringUtil.subString("62269910212", -4, 0));
		
		System.out.println("收到手机尾号" + StringUtil.markSpace(StringUtil.subString("18075134720", -4, 0)) + "的扫码付款15.65元!");
	}
