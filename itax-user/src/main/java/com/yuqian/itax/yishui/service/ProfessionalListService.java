...
import com.yuqian.itax.yishui.entity.ProfessionalListReq;
...
/**
 * 获取签约用户列表 ： http://doc.zhuoyankeji.com/web/#/13/310
 * @author Administrator
 */
@Slf4j
public class ProfessionalListService extends YiShuiSupport {

    private static final String URI = "/Enterprise/getProfessionalList";

    public static ContractInfoResp exec(ProfessionalListReq req, String token, YsMerConfig config){
        ...
        try{
            ...
            log.error("查询人员签约信息异常",e);
            resp.setCode("EX999");
            resp.setMsg("查询人员签约信息异常，请稍后再试");
            return resp;
        }
    }
     ...
     * @return
     */
    private static ContractInfoResp mock(ProfessionalListReq req, String token , YsMerConfig config){
    ...
    public static void main(String[] args) {
        ...
        String token = "sign_dde35097cb63b8d64c62daa4efeb0529";

        ProfessionalListReq req = new ProfessionalListReq();
        req.setKeywords("6222031904000208736");
        ContractInfoResp res = ProfessionalListService.exec(req,token,config);
